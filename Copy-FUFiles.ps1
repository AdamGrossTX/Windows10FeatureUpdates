...
.EXAMPLE
    ...
    Copy-FUFiles.PS1 -RemoveOnly

.EXAMPLE
    Copy all content
    Copy-FUFiles.PS1 -GUID "ca3d0b66-131d-4e85-b474-98565a01a1f2"
...
Param (
    [string]$GUID = "ca3d0b66-131d-4e85-b474-98565a01a1f2", 
    [switch]$RemoveOnly,
    [string]$TranscriptPath = "C:\Windows\CCM\Logs\FU-CopyFiles.log"
)
